        ...
        <div class="login-form">
          ...
          >
            <div class="login-btn1">
              <el-button @click="studentsubmit()" type="primary"
                >学生免密码登录</el-button
              >
            </div>
            <div class="login-btn2">
              <el-button @click="teachersubmit()" type="primary"
                >教师免密码登录</el-button
              >
            </div>
            <div class="login-btn3">
              <el-button @click="adminsubmit()" type="primary"
                >管理员免密码登录</el-button
              >
            </div>
          </el-form>
...
export default {
  ...
  methods: {
    studentsubmit() {
      login(10419832, 10419832).then((res) => {
    ...
    teachersubmit() {
      login(100001338, 100001338).then((res) => {
        this.$message.success("登录成功: " + res.username);
        this.$store.commit("login", res);
        this.$router.push({ name: "container" });
      });
